...
resource "aws_eks_cluster" "this" {
  ...
  access_config {
    authentication_mode = "API_AND_CONFIG_MAP" # Specify the desired mode
    # optional: bootstrap_cluster_creator_admin_permissions = true (default in the generic aws provider)
  }
